...
namespace QuickFont
{
    ...
    public class QFontDrawingPrimitive
    {
        ...
        /// <param name="clippingRectangle">The clipping rectangle to scissor test the text with</param>
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(string text, Vector3 position, QFontAlignment alignment, OpenTK.Color color, Rectangle clippingRectangle = default(Rectangle))
        {
        ...
        /// <param name="clippingRectangle">The clipping rectangle to scissor test the text with</param>
        /// <returns>The size of the printed text</returns>
        public SizeF Print(string text, Vector3 position, SizeF maxSize, QFontAlignment alignment, OpenTK.Color colour, Rectangle clippingRectangle = default(Rectangle))
        {
            ProcessedText processedText = ProcessText(Font, Options, text, maxSize, alignment);
        ...
        /// <param name="clippingRectangle">The clipping rectangle to scissor test the text with</param>
        /// <returns>The size of the printed text</returns>
        public SizeF Print(ProcessedText processedText, Vector3 position, OpenTK.Color colour, Rectangle clippingRectangle = default(Rectangle))
        {
        ...
        public static ProcessedText ProcessText(QFont font, QFontRenderOptions options, string text, OpenTK.SizeF maxSize, QFontAlignment alignment)
        {
