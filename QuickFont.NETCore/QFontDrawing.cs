...
namespace QuickFont
{
    ...
    public class QFontDrawing : IDisposable
    {
        ...
        public OpenTK.SizeF Print(QFont font, ProcessedText text, Vector3 position, QFontRenderOptions opt)
        {
        ...
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(QFont font, ProcessedText processedText, Vector3 position, OpenTK.Color? colour = null)
        {
        ...
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(QFont font, string text, Vector3 position, QFontAlignment alignment, QFontRenderOptions opt)
        {
            var dp = new QFontDrawingPrimitive(font, opt);
            DrawingPrimitives.Add(dp);
        ...
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(QFont font, string text, Vector3 position, QFontAlignment alignment, OpenTK.Color? color = null, OpenTK.Rectangle clippingRectangle = default(OpenTK.Rectangle))
        {
            var dp = new QFontDrawingPrimitive(font);
            DrawingPrimitives.Add(dp);
            if( color.HasValue )
        ...
        /// <param name="clippingRectangle">The clipping rectangle to scissor test the text with</param>
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(QFont font, string text, Vector3 position, OpenTK.SizeF maxSize, QFontAlignment alignment, OpenTK.Rectangle clippingRectangle = default(OpenTK.Rectangle))
        {
            var dp = new QFontDrawingPrimitive(font);
            DrawingPrimitives.Add(dp);
        ...
        /// <param name="opt">The render options</param>
        /// <returns>The size of the printed text</returns>
        public OpenTK.SizeF Print(QFont font, string text, Vector3 position, OpenTK.SizeF maxSize, QFontAlignment alignment, QFontRenderOptions opt )
        {
            var dp = new QFontDrawingPrimitive(font, opt);
            DrawingPrimitives.Add(dp);
