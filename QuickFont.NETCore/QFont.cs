...
namespace QuickFont
{
    ...
    public class QFont : IDisposable
    {
        ...
        public OpenTK.SizeF Measure(string text, OpenTK.SizeF maxSize, QFontAlignment alignment)
        {
        ...
        /// Measured size.
        /// </returns>
        public OpenTK.SizeF Measure(string text, float maxWidth, QFontAlignment alignment)
        {
            var test = new QFontDrawingPrimitive(this);
        ...
        /// Measured size.
        /// </returns>
        public OpenTK.SizeF Measure(ProcessedText processedText)
        {
            var test = new QFontDrawingPrimitive(this);
        ...
        /// Measured size.
        /// </returns>
        public OpenTK.SizeF Measure(string text, QFontAlignment alignment = QFontAlignment.Left)
        {
            var test = new QFontDrawingPrimitive(this);
