...
#region Set Listener parameters
        ...
        public static void Listener(ALListenerfv param, ref OpenTK.Vector3 at, ref OpenTK.Vector3 up)
        {
...
#region Get Listener parameters
        ...
        public static void GetListener(ALListener3f param, out OpenTK.Vector3 values)
        {
        ...
        /// <param name="at">A Math.Vector3 for the At-Vector.</param>
        /// <param name="up">A Math.Vector3 for the Up-Vector.</param>
        public static void GetListener(ALListenerfv param, out OpenTK.Vector3 at, out OpenTK.Vector3 up)
        {
...
#region Source3f
        ...
        [CLSCompliant(false)]
        public static void Source(uint sid, ALSource3f param, ref OpenTK.Vector3 values)
        {
        ...
        /// <param name="param">The name of the attribute to set: ALSource3f.Position, Velocity, Direction.</param>
        /// <param name="values">A Math.Vector3 which the attribute will be set to.</param>
        public static void Source(int sid, ALSource3f param, ref OpenTK.Vector3 values)
        {
...
#region GetSource3f
        ...
        [CLSCompliant(false)]
        public static void GetSource(uint sid, ALSource3f param, out OpenTK.Vector3 values)
        {
        ...
        /// <param name="param">the name of the attribute being retrieved: ALSource3f.Position, Velocity, Direction.</param>
        /// <param name="values">A Math.Vector3 to retrieve the values to.</param>
        public static void GetSource(int sid, ALSource3f param, out OpenTK.Vector3 values)
        {
...
#region BufferData
        ...
        {
            if (!OpenTK.BlittableValueType.Check(buffer))
