...
namespace Oxy.Framework.OpenTK.Compatibility
{
    ...
    public interface ITextPrinter : IDisposable
    {
        ...
        void Print(string text, System.Drawing.Font font, Color color);
        ...
        void Print(string text, System.Drawing.Font font, Color color, RectangleF rect);
        ...
        void Print(string text, System.Drawing.Font font, Color color, RectangleF rect, TextPrinterOptions options);
        ...
        void Print(string text, System.Drawing.Font font, Color color, RectangleF rect, TextPrinterOptions options, TextAlignment alignment);
        ...
        void Print(string text, System.Drawing.Font font, Color color, RectangleF rect, TextPrinterOptions options, TextAlignment alignment, TextDirection direction);
        ...
        TextExtents Measure(string text, System.Drawing.Font font);
        ...
        /// <param name="rect">The System.Drawing.Rectangle that defines the bounds for text layout.</param>
        /// <returns>An OpenTK.Graphics.TextExtents instance that contains the results of the measurement.</returns>
        TextExtents Measure(string text, System.Drawing.Font font, RectangleF rect);
        ...
        /// <returns>An OpenTK.Graphics.TextExtents instance that contains the results of the measurement.</returns>
        TextExtents Measure(string text, System.Drawing.Font font, RectangleF rect, TextPrinterOptions options);
        ...
        /// <returns>An OpenTK.Graphics.TextExtents instance that contains the results of the measurement.</returns>
        TextExtents Measure(string text, System.Drawing.Font font, RectangleF rect, TextPrinterOptions options, TextAlignment alignment);
        ...
        /// <returns>An OpenTK.Graphics.TextExtents instance that contains the results of the measurement.</returns>
        TextExtents Measure(string text, System.Drawing.Font font, RectangleF rect, TextPrinterOptions options, TextAlignment alignment, TextDirection direction);
