    ...
    internal static class GdiPlus
    {
        ...
        static GdiPlus()
        {
            if (Configuration.RunningOnWindows && !Configuration.RunningOnMono)
                internals = new global::Oxy.Framework.OpenTK.Compatibility.Windows.WinGdiPlusInternals();
           else
                internals = new global::Oxy.Framework.OpenTK.Compatibility.X11.X11GdiPlusInternals(); // This class is Mono-specific and works on all platforms.
        }
