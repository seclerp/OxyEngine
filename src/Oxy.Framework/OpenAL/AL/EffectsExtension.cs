...
namespace Oxy.Framework.OpenAL.AL
{
  ...
  public partial class EffectsExtension
  {
    ...
    ///   successfully created. If the function call fails then none of the requested Effect Slots are created. A good strategy
    ///   for creating any OpenAL object is to use a for-loop and generate one object each loop iteration and then check for an
    ///   error condition. If an error is set then the loop can be broken and the application can determine if sufficient
    ...
    public EffectsExtension()
    {
      ...
      if (!AudioContext.CurrentContext.SupportsExtension("ALC_EXT_EFX"))
      {
        Debug.Print("EFX Extension (ALC_EXT_EFX) is not supported(AudioContext: {0}).",
          AudioContext.CurrentContext.ToString());
        return;
      }
      ...
      try
      {
        ...
        Imported_alDeleteEffects =
          (Delegate_alDeleteEffects) Marshal.GetDelegateForFunctionPointer(AL.GetProcAddress("alDeleteEffects"),
            typeof(Delegate_alDeleteEffects));
        Imported_alIsEffect =
      ...
      try
      {
        ...
        Imported_alDeleteFilters =
          (Delegate_alDeleteFilters) Marshal.GetDelegateForFunctionPointer(AL.GetProcAddress("alDeleteFilters"),
            typeof(Delegate_alDeleteFilters));
        Imported_alIsFilter =
      ...
      try
      {
        ...
        Imported_alDeleteAuxiliaryEffectSlots =
          (Delegate_alDeleteAuxiliaryEffectSlots) Marshal.GetDelegateForFunctionPointer(
            AL.GetProcAddress("alDeleteAuxiliaryEffectSlots"), typeof(Delegate_alDeleteAuxiliaryEffectSlots));
