...
namespace Oxy.Framework.OpenAL.AL
{
  ...
  {
    internal static readonly NativeLibrary ALNativeLib = NativeLibrary.Load(GetOpenALLibName());
    ...
    private delegate void alEnable_d(ALCapability capability);

    private static readonly alEnable_d alEnable_ptr = ALNativeLib.LoadFunctionPointer<alEnable_d>("alEnable");
    ...
    {
      alEnable_ptr(capability);
    }
    //AL_API void AL_APIENTRY alEnable( ALenum capability );

    private delegate void alDisable_d(ALCapability capability);

    private static readonly alDisable_d alDisable_ptr = ALNativeLib.LoadFunctionPointer<alDisable_d>("alDisable");
    ...
    {
      alDisable_ptr(capability);
    }
    // AL_API void AL_APIENTRY alDisable( ALenum capability ); 

    private delegate bool IsEnabled_d(ALCapability capability);

    private static readonly IsEnabled_d alIsEnabled_ptr = ALNativeLib.LoadFunctionPointer<IsEnabled_d>("alIsEnabled");
    ...
    {
      return alIsEnabled_ptr(capability);
    }
    ...
    private delegate IntPtr GetStringPrivate_d(ALGetString param);

    private static readonly GetStringPrivate_d alGetString_ptr =
      ALNativeLib.LoadFunctionPointer<GetStringPrivate_d>("alGetString");

    private static IntPtr GetStringPrivate(ALGetString param)
    {
      return alGetString_ptr(param);
    }
    ...
    private delegate int Get_d(ALGetInteger param);

    private static readonly Get_d alGetInteger_ptr = ALNativeLib.LoadFunctionPointer<Get_d>("alGetInteger");
    ...
    {
      return alGetInteger_ptr(param);
    }
    // AL_API ALint AL_APIENTRY alGetInteger( ALenum param );

    private delegate float GetFloat_d(ALGetFloat param);

    private static readonly GetFloat_d alGetFloat_ptr = ALNativeLib.LoadFunctionPointer<GetFloat_d>("alGetFloat");
    ...
    private delegate ALError GetError_d();

    private static readonly GetError_d alGetError_ptr = ALNativeLib.LoadFunctionPointer<GetError_d>("alGetError");
    ...
    ///   When an OpenAL error occurs, the error state is set and will not be changed until the error state is retrieved using
    ///   alGetError. Whenever alGetError is called, the error state is cleared and the last state (the current state when the
    ///   call was made) is returned. To isolate error detection to a specific portion of code, alGetError should be called
    ///   before the isolated section to clear the current error state.
    /// </returns>
    public static ALError GetError()
    {
      return alGetError_ptr();
    }
    ...
    {
      return IsExtensionPresent_dptr(extname);
    }

    private static readonly IsExtensionPresent_d IsExtensionPresent_dptr =
      ALNativeLib.LoadFunctionPointer<IsExtensionPresent_d>("alIsExtensionPresent");

    private delegate bool IsExtensionPresent_d([In] string extname);
    ...
    {
      return GetProcAddress_dptr(fname);
    }

    private static readonly GetProcAddress_d GetProcAddress_dptr =
      ALNativeLib.LoadFunctionPointer<GetProcAddress_d>("alGetProcAddress");

    private delegate IntPtr GetProcAddress_d([In] string fname);
    ...
    {
      return GetEnumValue_dptr(ename);
    }

    private static readonly GetEnumValue_d GetEnumValue_dptr =
      ALNativeLib.LoadFunctionPointer<GetEnumValue_d>("alGetEnumValue");

    private delegate int GetEnumValue_d([In] string ename);
    ...
    {
      Listener_dptr(param, value);
    }

    private static readonly Listener_d Listener_dptr = ALNativeLib.LoadFunctionPointer<Listener_d>("alListenerf");

    private delegate void Listener_d(ALListenerf param, float value);
    ...
    {
      Listener3_dptr(param, value1, value2, value3);
    }

    private static readonly Listener3_d Listener3_dptr = ALNativeLib.LoadFunctionPointer<Listener3_d>("alListener3f");

    private delegate void Listener3_d(ALListener3f param, float value1, float value2, float value3);
    ...
    private static readonly ListenerPrivate_d alListenerfv_ptr =
      ALNativeLib.LoadFunctionPointer<ListenerPrivate_d>("alListenerfv");

    private static unsafe void ListenerPrivate(ALListenerfv param, float* values)
    {
      alListenerfv_ptr(param, values);
    }
    ...
    public static void GetListener(ALListenerf param, [Out] out float value)
    {
      GetListener_dptr(param, out value);
    }

    private static readonly GetListener_d GetListener_dptr =
      ALNativeLib.LoadFunctionPointer<GetListener_d>("alGetListenerf");

    private delegate void GetListener_d(ALListenerf param, [Out] out float value);
    ...
    public static void GetListener(ALListener3f param, [Out] out float value1, [Out] out float value2,
      [Out] out float value3)
    {
      GetListener3_dptr(param, out value1, out value2, out value3);
    }

    private static readonly GetListener3_d GetListener3_dptr =
      ALNativeLib.LoadFunctionPointer<GetListener3_d>("alGetListener3f");

    private delegate void GetListener3_d(ALListener3f param, [Out] out float value1, [Out] out float value2,
      [Out] out float value3);
    ...
    public static unsafe void GetListener(ALListenerfv param, float* values)
    {
      GetListenerfv_dptr(param, values);
    }

    private static readonly GetListenerfv_d GetListenerfv_dptr =
      ALNativeLib.LoadFunctionPointer<GetListenerfv_d>("alGetListenerfv");
    ...
    private static readonly GenSourcesPrivate_D alGenSources_ptr =
      ALNativeLib.LoadFunctionPointer<GenSourcesPrivate_D>("alGenSources");

    private static unsafe void GenSourcesPrivate(int n, [Out] uint* sources)
    {
      alGenSources_ptr(n, sources);
    }
    ...
    public static void GenSources(int[] sources)
    {
      ...
      for (int i = 0; i < temp.Length; i++) sources[i] = (int) temp[i];
    }
    ...
    [CLSCompliant(false)]
    public static unsafe void DeleteSources(int n, [In] uint* sources)
    {
      DeleteSources_dptr(n, sources);
    }

    private static readonly DeleteSources_d DeleteSources_dptr =
      ALNativeLib.LoadFunctionPointer<DeleteSources_d>("alDeleteSources");
    ...
    {
      DeleteSources1_dptr(n, ref sources);
    }

    private static readonly DeleteSources1_d DeleteSources1_dptr =
      ALNativeLib.LoadFunctionPointer<DeleteSources1_d>("alDeleteSources");
    ...
    {
      DeleteSources2_dptr(n, ref sources);
    }

    private static readonly DeleteSources2_d DeleteSources2_dptr =
      ALNativeLib.LoadFunctionPointer<DeleteSources2_d>("alDeleteSources");
    ...
    {
      return IsSource_dptr(sid);
    }

    private static readonly IsSource_d IsSource_dptr = ALNativeLib.LoadFunctionPointer<IsSource_d>("alIsSource");

    private delegate bool IsSource_d(uint sid);
    ...
    {
      Source_dptr(sid, param, value);
    }

    private static readonly Source_d Source_dptr = ALNativeLib.LoadFunctionPointer<Source_d>("alSourcef");

    private delegate void Source_d(uint sid, ALSourcef param, float value);
    ...
    {
      Source3_dptr(sid, param, value1, value2, value3);
    }

    private static readonly Source3_d Source3_dptr = ALNativeLib.LoadFunctionPointer<Source3_d>("alSource3f");

    private delegate void Source3_d(uint sid, ALSource3f param, float value1, float value2, float value3);
    ...
    {
      Sourcei_dptr(sid, param, value);
    }

    private static readonly Sourcei_d Sourcei_dptr = ALNativeLib.LoadFunctionPointer<Sourcei_d>("alSourcei");

    private delegate void Sourcei_d(uint sid, ALSourcei param, int value);
    ...
    {
      Source3i_dptr(sid, param, value1, value2, value3);
    }

    private static readonly Source3i_d Source3i_dptr = ALNativeLib.LoadFunctionPointer<Source3i_d>("alSource3i");

    private delegate void Source3i_d(uint sid, ALSource3i param, int value1, int value2, int value3);
    ...
    /// </param>
    /// <param name="value">A pointer to the floating-point value being retrieved</param>
    public static void GetSource(uint sid, ALSourcef param, [Out] out float value)
    {
      GetSource_dptr(sid, param, out value);
    }

    private static readonly GetSource_d GetSource_dptr = ALNativeLib.LoadFunctionPointer<GetSource_d>("alGetSourcef");

    private delegate void GetSource_d(uint sid, ALSourcef param, [Out] out float value);
    ...
    public static void GetSource(uint sid, ALSource3f param, [Out] out float value1, [Out] out float value2,
      [Out] out float value3)
    {
      GetSource3_dptr(sid, param, out value1, out value2, out value3);
    }

    private static readonly GetSource3_d GetSource3_dptr =
      ALNativeLib.LoadFunctionPointer<GetSource3_d>("alGetSource3f");

    private delegate void GetSource3_d(uint sid, ALSource3f param, [Out] out float value1, [Out] out float value2,
      [Out] out float value3);
    ...
    public static void GetSource(uint sid, ALGetSourcei param, [Out] out int value)
    {
      GetSourcei_dptr(sid, param, out value);
    }

    private static readonly GetSourcei_d
      GetSourcei_dptr = ALNativeLib.LoadFunctionPointer<GetSourcei_d>("alGetSourcei");

    private delegate void GetSourcei_d(uint sid, ALGetSourcei param, [Out] out int value);
    ...
    public static unsafe void SourcePlay(int ns, [In] uint* sids)
    {
      SourcePlayv_dptr(ns, sids);
    }

    private static readonly SourcePlayv_d SourcePlayv_dptr =
      ALNativeLib.LoadFunctionPointer<SourcePlayv_d>("alSourcePlayv");
    ...
    public static void SourcePlay(int ns, int[] sids)
    {
      ...
      for (int i = 0; i < ns; i++) temp[i] = (uint) sids[i];
      SourcePlay(ns, temp);
    }
    ...
    public static unsafe void SourceStop(int ns, [In] uint* sids)
    {
      SourceStopv_dptr(ns, sids);
    }

    private static readonly SourceStopv_d SourceStopv_dptr =
      ALNativeLib.LoadFunctionPointer<SourceStopv_d>("alSourceStopv");
    ...
    public static unsafe void SourceRewind(int ns, [In] uint* sids)
    {
      SourceRewindv_dptr(ns, sids);
    }

    private static readonly SourceRewindv_d SourceRewindv_dptr =
      ALNativeLib.LoadFunctionPointer<SourceRewindv_d>("alSourceRewindv");
    ...
    public static unsafe void SourcePause(int ns, [In] uint* sids)
    {
      SourcePausev_dptr(ns, sids);
    }

    private static readonly SourcePausev_d SourcePausev_dptr =
      ALNativeLib.LoadFunctionPointer<SourcePausev_d>("alSourcePausev");
    ...
    private static readonly SourcePlay_d
      SourcePlay_dptr = ALNativeLib.LoadFunctionPointer<SourcePlay_d>("alSourcePlay");

    private delegate void SourcePlay_d(uint sid);
    ...
    private static readonly SourceStop_d
      SourceStop_dptr = ALNativeLib.LoadFunctionPointer<SourceStop_d>("alSourceStop");

    private delegate void SourceStop_d(uint sid);
    ...
    {
      SourceRewind_dptr(sid);
    }

    private static readonly SourceRewind_d SourceRewind_dptr =
      ALNativeLib.LoadFunctionPointer<SourceRewind_d>("alSourceRewind");

    private delegate void SourceRewind_d(uint sid);
    ...
    {
      SourcePause_dptr(sid);
    }

    private static readonly SourcePause_d SourcePause_dptr =
      ALNativeLib.LoadFunctionPointer<SourcePause_d>("alSourcePause");

    private delegate void SourcePause_d(uint sid);
    ...
    public static unsafe void SourceQueueBuffers(uint sid, int numEntries, [In] uint* bids)
    {
      SourceQueueBuffers_dptr(sid, numEntries, bids);
    }

    private static readonly SourceQueueBuffers_d SourceQueueBuffers_dptr =
      ALNativeLib.LoadFunctionPointer<SourceQueueBuffers_d>("alSourceQueueBuffers");
    ...
    public static void SourceQueueBuffers(int sid, int numEntries, int[] bids)
    {
      ...
      for (int i = 0; i < numEntries; i++) temp[i] = (uint) bids[i];
    ...
    ///   unqueued using this call. The unqueue operation will only take place if all n buffers can be removed from the queue.
    /// </summary>
    ...
    public static unsafe void SourceUnqueueBuffers(uint sid, int numEntries, [In] uint* bids)
    {
      SourceUnqueueBuffers1_dptr(sid, numEntries, bids);
    }

    private static readonly SourceUnqueueBuffers1_d SourceUnqueueBuffers1_dptr =
      ALNativeLib.LoadFunctionPointer<SourceUnqueueBuffers1_d>("alSourceUnqueueBuffers");
    ...
    {
      SourceUnqueueBuffers2_dptr(sid, numEntries, bids);
    }

    private static readonly SourceUnqueueBuffers2_d SourceUnqueueBuffers2_dptr =
      ALNativeLib.LoadFunctionPointer<SourceUnqueueBuffers2_d>("alSourceUnqueueBuffers");
    ...
    {
      SourceUnqueueBuffers3_dptr(sid, numEntries, bids);
    }

    private static readonly SourceUnqueueBuffers3_d SourceUnqueueBuffers3_dptr =
      ALNativeLib.LoadFunctionPointer<SourceUnqueueBuffers3_d>("alSourceUnqueueBuffers");
    ...
    {
      SourceUnqueueBuffers4_dptr(sid, numEntries, ref bids);
    }

    private static readonly SourceUnqueueBuffers4_d SourceUnqueueBuffers4_dptr =
      ALNativeLib.LoadFunctionPointer<SourceUnqueueBuffers4_d>("alSourceUnqueueBuffers");
    ...
    {
      SourceUnqueueBuffers5_dptr(sid, numEntries, ref bids);
    }

    private static readonly SourceUnqueueBuffers5_d SourceUnqueueBuffers5_dptr =
      ALNativeLib.LoadFunctionPointer<SourceUnqueueBuffers5_d>("alSourceUnqueueBuffers");
    ...
    {
      GenBuffers_dptr(n, buffers);
    }

    private static readonly GenBuffers_d
      GenBuffers_dptr = ALNativeLib.LoadFunctionPointer<GenBuffers_d>("alGenBuffers");
    ...
    {
      GenBuffersS_dptr(n, buffers);
    }

    private static readonly GenBuffersS_d GenBuffersS_dptr =
      ALNativeLib.LoadFunctionPointer<GenBuffersS_d>("alGenBuffers");
    ...
    ///   attached to a source can not be deleted. See AL.Source (ALSourcei) and AL.SourceUnqueueBuffers for information on how
    ///   to detach a buffer from a source.
    /// </summary>
    ...
    [CLSCompliant(false)]
    public static unsafe void DeleteBuffers(int n, [In] uint* buffers)
    {
      DeleteBuffers_dptr(n, buffers);
    }

    private static readonly DeleteBuffers_d DeleteBuffers_dptr =
      ALNativeLib.LoadFunctionPointer<DeleteBuffers_d>("alDeleteBuffers");
    ...
    {
      DeleteBuffersS_dptr(n, buffers);
    }

    private static readonly DeleteBuffersS_d DeleteBuffersS_dptr =
      ALNativeLib.LoadFunctionPointer<DeleteBuffersS_d>("alDeleteBuffers");
    ...
    ///   a source can not be deleted. See AL.Source (ALSourcei) and AL.SourceUnqueueBuffers for information on how to detach a
    ...
    {
      return IsBuffer_dptr(bid);
    }

    private static readonly IsBuffer_d IsBuffer_dptr = ALNativeLib.LoadFunctionPointer<IsBuffer_d>("alIsBuffer");

    private delegate bool IsBuffer_d(uint bid);
    ...
    {
      BufferData_dptr(bid, format, buffer, size, freq);
    }

    private static readonly BufferData_d
      BufferData_dptr = ALNativeLib.LoadFunctionPointer<BufferData_d>("alBufferData");

    private delegate void BufferData_d(uint bid, ALFormat format, IntPtr buffer, int size, int freq);
    ...
    public static void GetBuffer(uint bid, ALGetBufferi param, [Out] out int value)
    {
      GetBuffer_dptr(bid, param, out value);
    }

    private static readonly GetBuffer_d GetBuffer_dptr = ALNativeLib.LoadFunctionPointer<GetBuffer_d>("alGetBufferi");

    private delegate void GetBuffer_d(uint bid, ALGetBufferi param, [Out] out int value);
    ...
    {
      DopplerFactor_dptr(value);
    }

    private static readonly DopplerFactor_d DopplerFactor_dptr =
      ALNativeLib.LoadFunctionPointer<DopplerFactor_d>("alDopplerFactor");

    private delegate void DopplerFactor_d(float value);
    ...
    {
      DopplerVelocity_dptr(value);
    }

    private static readonly DopplerVelocity_d DopplerVelocity_dptr =
      ALNativeLib.LoadFunctionPointer<DopplerVelocity_d>("alDopplerVelocity");

    private delegate void DopplerVelocity_d(float value);
    ...
    {
      SpeedOfSound_dptr(value);
    }

    private static readonly SpeedOfSound_d SpeedOfSound_dptr =
      ALNativeLib.LoadFunctionPointer<SpeedOfSound_d>("alSpeedOfSound");

    private delegate void SpeedOfSound_d(float value);
    ...
    {
      DistanceModel_dptr(distancemodel);
    }

    private static readonly DistanceModel_d DistanceModel_dptr =
      ALNativeLib.LoadFunctionPointer<DistanceModel_d>("alDistanceModel");

    private delegate void DistanceModel_d(ALDistanceModel distancemodel);
